...
let Parts = {
	...
	Show: (NextLevel) => {
        ...
        h.push('<table style="margin-bottom: 3px; width: 100%"><tr><td style="width: 50%" class="text-center">');
        ...
        h.push('</tr><tr>');
        h.push('<td class="text-center" style="width: 50%">' + i18n('Boxes.OwnpartCalculator.PatronPart') + ': <strong class="' + (PlayerID === ExtPlayerID ? '' : 'success') + '">' + HTML.Format(MaezenTotal + ExtTotal) + '</strong></td>');
        ...
        h.push('<tr>');
        if (EigenStart > 0) {
            h.push('<td class="text-center" style="width: 50%">' + i18n('Boxes.OwnpartCalculator.LGTotalFP') + ': <strong>' + HTML.Format(Total) + '</strong></td>');
