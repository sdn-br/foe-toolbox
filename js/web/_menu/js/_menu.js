...
let _menu = {
	...
	*/
	 ...
	 */
	sabotage_Btn: () => {
		let btn_SabotageBG = _menu.MakeButton(
			'sabotage', 
			i18n('Menu.Sabotage.Title'), 
			'<em id="sabotage-Btn-closed" class="tooltip-error">' + i18n('Menu.Sabotage.Warning') + '<br></em>' + i18n('Menu.Sabotage.Desc'),
			true);
		...
		return btn_SabotageBG.append(btn_Sabotage);
	},
	 ...
	 */
	looting_Btn: () => {
		let btn_LootingBG = _menu.MakeButton('looting', i18n('Menu.Looting.Title'), i18n('Menu.Looting.Desc'));
