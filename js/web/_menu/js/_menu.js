...
let _menu = {
	...
	*/
	...
	sabotage_Btn: () => {
		...
		btn_SabotageBG = _menu.toolTipp(btn_SabotageBG, i18n('Menu.Sabotage.Title'), '<em id="sabotage-Btn-closed" class="tooltip-error">' + i18n('Menu.Sabotage.Warning') + '<br></em>' + i18n('Menu.Sabotage.Desc'), 'sabotage-Btn');
	...
	looting_Btn: () => {
		...
		btn_LootingBG = _menu.toolTipp(btn_LootingBG, i18n('Menu.Looting.Title'), i18n('Menu.Looting.Desc'), 'looting-Btn');
