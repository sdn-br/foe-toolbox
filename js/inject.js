...
// separate code from global scope
{
	...
	if (uLng !== null && Languages.PossibleLanguages[uLng] !== undefined){
		lng = uLng;
	} else {
	...
	async function InjectCode() {
		try {
			...
			if (document.getElementById('content') && !IsForum ){
				alert('You installed the FoE Toolbox but didn\'t switch the game to HTML5. Check that in your game settings!');
			}
